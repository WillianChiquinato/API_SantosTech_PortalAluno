...
public interface IBadgeRepository
{
    ...
    Task<List<ActivatedGoalResponse>> GetActivatedGoalsByUserAndCourseIdAsync(int userId, int courseId);
    Task<bool> GoalRewardOperationAsync(int goalRewardId, int userId);
}
