...
namespace API_PortalSantosTech.Data.Migrations
{
    ...
    [Migration("20260520170203_TeamClansAttributes")]
    partial class TeamClansAttributes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API_PortalSantosTech.Models.FinalChallengeActivityRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("final_challenge_activity");
                });

            modelBuilder.Entity("API_PortalSantosTech.Models.FinalChallengeClanRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("final_challenge_clan");
                });

            modelBuilder.Entity("API_PortalSantosTech.Models.FinalChallengeEventRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int?>("RankingEventId")
                        .HasColumnType("integer")
                        .HasColumnName("ranking_event_id");
                    ...
                    b.ToTable("final_challenge_event");
                });

            modelBuilder.Entity("API_PortalSantosTech.Models.FinalChallengeSubmissionRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("final_challenge_submission");
                });

            modelBuilder.Entity("API_PortalSantosTech.Models.FinalChallengeTaskRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("final_challenge_task");
                });
            ...
            modelBuilder.Entity("API_PortalSantosTech.Models.FinalChallengeActivityRecord", b =>
                {
                    b.HasOne("API_PortalSantosTech.Models.FinalChallengeClanRecord", "Clan")
                        .WithMany()
                        .HasForeignKey("ClanId");

                    b.HasOne("API_PortalSantosTech.Models.FinalChallengeEventRecord", "Event")
                        .WithMany()
            ...
            modelBuilder.Entity("API_PortalSantosTech.Models.FinalChallengeEventRecord", b =>
                {
                    ...
                    b.HasOne("API_PortalSantosTech.Models.RankingEvent", "RankingEvent")
                        .WithMany()
            ...
            modelBuilder.Entity("API_PortalSantosTech.Models.FinalChallengeSubmissionRecord", b =>
                {
                    ...
                    b.HasOne("API_PortalSantosTech.Models.FinalChallengeTaskRecord", "Task")
                        .WithMany()
